...
######################################################################
#
#   Hard fork of the Julia package LocalRegistry.jl - 2021-08-25 - v0.7
#   Author: Gunnar Farnebäck
#     Repo: https://github.com/GunnarFarneback/LocalRegistry.jl
#  License: "The LocalRegistry.jl package is licensed under the MIT "Expat" License"
#
#  dependencies: RegistryTools = "1.4" in [compat] as of v0.7
#
######################################################################
#
#  Reason: we need to handle Git action under a custom user and access
#  pattern. Calls to git are deeply nested here so it did not seem
#  practical to work arount it using some post precessing...
#
#  We try to keep the patch localized, so a compare against the
#  upstream version should be possible. We may do a PR of our
#  extensions if they proove usefull / stable.
#
######################################################################
