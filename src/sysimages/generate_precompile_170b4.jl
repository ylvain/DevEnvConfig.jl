...
#
#
# FILE COPIED FROM Julia repo tag 1.7.0-beta4, found in \contrib
# Precompile for Artifact are disabled to run with v1.6
# See FIXME in the code below
#
#
...
#
# FIXME: Disable to run on 1.6.1, the Artifacts does not have all test data that it has on 1.7.0
#
